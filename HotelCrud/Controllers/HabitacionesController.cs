...
namespace HotelCrud.Controllers
{
    public class HabitacionesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Numero,Tipo,Precio,Estado")] Habitacione habitacione)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Numero,Tipo,Precio,Estado")] Habitacione habitacione)
        {
